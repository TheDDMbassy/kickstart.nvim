return { -- LSP Plugins
  {
    ...
    --
    -- Useful if you're actively writing Lua code in Neovim, which is
    -- essentially anytime you're editing your Neovim config, but maybe you'll
    -- start writing Lua in other files as well someday :)
    --
    -- Much faster autocompletion, and the completions are more accurate/less noisy.
    'folke/lazydev.nvim',
    ft = 'lua',
    opts = {
      library = {
        ...
        callback = function(event)
          ...
          local function client_supports_method(client, method, bufnr)
            if vim.fn.has 'nvim-0.11' == 1 then
              ...
              -- The above line shipped with kickstart.nvim, but I don't need it as long as I stay on 0.11 or above.
              -- For the next minor release, I'll probably get new code here anyway after I sync my fork.
              print 'DDM has messed up, we should never get here'
              return false
            end
          end
